		...
		return (
			<Content className="content">
				...
				<div>
					...
					<p>I first got a taste of programming in middle school when I discovered the <a href="https://www.codecademy.com/learn/introduction-to-javascript" target="_blank">Codeacademy course for JavaScript</a>. Within an hour of finding the course, I was proudly showing my mom that I was a "programmer" with my JavaScript for loops!</p>
