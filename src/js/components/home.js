        ...
        return (
                <div className="content">
                    <div className="text col-md-8">
                        ...
                        <div className="text-block">After joining the App Dev department, I worked with others on our streaming service, <a href="https://atthecontrol.com/">At The Control</a>, which was used to be able to
                            remotely watch and keep up with robotics events.</div>
                        <div className="text-block">Now I am a soon to be freshman (as of June 2017) at <a hef="https://msoe.edu">MSOE</a> where I plan to get my bachelors in Software Engineering.<br /><br />
